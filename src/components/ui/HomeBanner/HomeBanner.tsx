        ...
        <div id="home" className='flex w-full flex-col-reverse lg:flex-row justify-around items-center my-10'>
            <div className='w-full lg:w-[38%]'>
                ...
                <div className='flex flex-col lg:flex-row items-center justify-center mt-5 '>
                    ...
                    <Button className='flex justify-center items-center bg-[#2b2f47] hover:bg-[#0F1225] py-5 px-8 mr-5' type="primary"><span className='text-xl  mr-2 '> <PhoneOutlined /></span> Call Now</Button>
                    </Link>
                    <Link href={`tel:${phoneNumber}`} className="no-underline">
                    <Button className='flex justify-center items-center bg-[#292e49] hover:bg-[#0F1225] border-0 py-5 px-8' type="primary"><span className='text-xl mr-2'> <WhatsAppOutlined /> </span> Whatsapp</Button>
                    </Link>
